...
<div class="py-2 w-full">
    <div class="flex items-center justify-between">
        ...
        <div @click="isMenu = !isMenu" class="relative">
            ...
            >
            <Icon v-if="!isDeleting" name="mdi:dots-horizontal" color="#ffffff" size="18"/>
            <Icon v-else name="eos-icons:bubble-loading" color="ffffff" size="18"/>

            </button>
            <div
            v-if="isMenu"
             class="absolute border border-gray-500 right-0 z-20 mt-1 rounded">

                <button
                class="flex flex-items-center rounded gap-2 text-red-500 justify-between bg-black w-full pl-4 pr-3 py-3 hover:bg-gray-900"
                >
                <div>Delete</div>
    ...
    <div class="relative inline-block text-gray-500 pt-1 pb-1 5">
        ...
        <div class="flex gap-0.5">
            <img src="https://picsum.photos/id/233/50" class="rounded-full h-[17px] mt-2">
            <img src="https://picsum.photos/id/233/50" class="rounded-full h-[17px]">
        </div>
        <div class="flex items-center">
             <img src="https://picsum.photos/id/99/50" class="rounded-full h-[11px] ml-4">
        </div>
        </div>
    </div>
