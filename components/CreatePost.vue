<template>
    <div id="CreatePost" class="fixed bottom-0 z-50 h-full w-full">
            <div class="bg-black h-full w-full text-white overflow-auto">
                ...
                <div id="Post" class="z-40 bottom-9 max-h-[100vh-200px] w-full px-3 max-w-[500px] mx-auto">
                    <div class="py-2 w-full">
                        <div class="flex items-center">

                            <div class="flex items-center text-white">
                                <img src="https://picsum.photos/id/233/50" class="rounded-full h-[35px]">
                        ...
                        <div class="relative flex items-center w-full">
                            ...
                            <div class="bg-black rounded-lg w-[calc(100%-50px)] text w-full font-light">
                                <div class="pt-2 text-gray-300 bg-black w-full">
                                    <textarea v-model="text" style="resize: none;" placeholder="Start a thread..." id="textarea" @input="modifyTextAreaHeight()" class="w-full bg-black outline-none"></textarea>
                                </div>
                                <div class="w-full">
